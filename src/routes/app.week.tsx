...
function Week() {
  ...
  return (
    <Shell>
      ...
      <WeeklyGate
        feature="week"
        title="Plano semanal 1x por semana no Básico"
        description="Use seu acesso desta semana para ver a divisão completa dos 7 dias, ou tenha visão diária no Premium."
      >
